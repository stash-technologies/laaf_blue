...
class BlueState {
  ...
  Observable<BluetoothStatus> bluetoothStatus =
      Observable(BluetoothStatus.uninitialized, "bluetooth status");
  ...
  Observable<List<LFLiner>> scannedDevices =
      Observable(List.empty(), "scanned devices");
  ...
  StepDataCalculator stepDataClaculator = StepDataCalculator(6);
}
